    ...
    run: async (client, message, args) => {
        ...
        function getAll(client, message) {
            ...
            *more coming soon*
            ...
            >>> <@692745044100382731> \`ΣПVヽ ♡ᴺᵉˣ 𝙋𝙄𝙆𝘼𝘾𝙃𝙐࿐#3378\` [\`Support Server\`](https://discord.gg/9AjdNzezyh)
            `)
                .addField("**__Music - Supported sources__**", `
            >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](https://links.musicium.eu), ...
            `)
                .setFooter(`Made by: Zone/Pikachu | ΣПVヽ ♡ᴺᵉˣ 𝙋𝙄𝙆𝘼𝘾𝙃𝙐࿐#3378`, client.user.displayAvatarURL())
